package com.liugui.rediscacheliugui.controller;

import com.liugui.rediscacheliugui.model.Person;
...
public class UserController {
    ...
    public String set() {
        ...
        redisTemplate.opsForValue().set("person", new Person(1L, "liugui", "123456789"));

        // 测试线程安全
        ExecutorService executorService = Executors.newFixedThreadPool(1000);
        IntStream.range(0, 1000).forEach(i -> executorService.execute(() -> stringRedisTemplate.opsForValue().increment("num", 1)));
        return "Ok!";
    }
